  ...
  const [projects, setProjects] = useState([
    {
      _id: "p1",
      title: "SnapPDF",
      description: "SnapPDF is a web-based PDF utility platform designed to help users easily manage and convert digital documents online. It provides a collection of essential tools that simplify working with PDF files without requiring software installation.",
    ...
    <section id="projects" className="pt-24 md:pt-32 pb-24 md:pb-40 bg-[var(--background)] border-t border-white/10 relative overflow-hidden">
      <div className="w-full">
        ...
        <div className="flex flex-col items-center md:items-start md:flex-row md:justify-between gap-6 mb-10 md:mb-16 px-6 md:px-12 max-w-[1600px] mx-auto z-10 relative">
          ...
          <p className="text-[#a0a0b0] text-sm md:text-base text-center md:text-right font-medium tracking-wide leading-relaxed max-w-xs md:max-w-[320px]">
