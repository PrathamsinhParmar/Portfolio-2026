          ...
          >
            ...
            <div className="mt-10 md:mt-16 space-y-6 md:space-y-8">
              <div>
                ...
                <a href="mailto:prthamsinhparmar0@gmail.com" className="text-lg sm:text-xl md:text-2xl font-bold hover:text-accent1 transition-colors underline underline-offset-8 decoration-white/10 hover:decoration-accent1 break-all">prthamsinhparmar0@gmail.com</a>
              </div>
              <div>
                <h4 className="text-sm font-black tracking-widest text-white/40 uppercase mb-2">Location</h4>
                <p className="text-lg sm:text-xl md:text-2xl font-bold text-white">Vadodara, Gujarat, India</p>
              </div>
            </div>
          </motion.div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col space-y-8 md:space-y-16 mt-4 md:mt-8">
              ...
              <div className="relative group">
                <div className="flex items-baseline gap-3 md:gap-4 mb-2 md:mb-4">
                  ...
                  <label htmlFor="name" className="text-xl md:text-3xl font-bold text-white/50 group-focus-within:text-white transition-colors">What's your name?</label>
                </div>
                <input 
                  type="text" 
                  id="name"
              ...
              <div className="relative group">
                <div className="flex items-baseline gap-3 md:gap-4 mb-2 md:mb-4">
                  <span className="text-xs md:text-sm font-bold text-accent2 font-mono">02</span>
                  <label htmlFor="email" className="text-xl md:text-3xl font-bold text-white/50 group-focus-within:text-white transition-colors">What's your email?</label>
                </div>
                <input 
                  type="email" 
                  id="email"
